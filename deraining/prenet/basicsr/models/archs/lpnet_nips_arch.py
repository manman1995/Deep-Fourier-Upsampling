...
class Z_LPNet(nn.Module):

    def __init__(self, in_chn=3, num_pyramids=5,num_blocks=5, num_feature=16,relu_slope=0.2):
        super(Z_LPNet, self).__init__()
    ...
    def forward(self, images):
        ...
        out_0_t = out_0_t + self.fup0(out_0)
        ...
        out_1_t = out_1_t + self.fup1(out_1)
        ...
        out_2_t = out_2_t + self.fup2(out_2)
...
class Subnet(nn.Module):
    def __init__(self,num_feature, num_blocks):
        ...
        self.conv_4 = nn.Conv2d(num_feature, 3, kernel_size=1,  bias=True)
