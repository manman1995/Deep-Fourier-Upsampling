...
class LPNet_corner(nn.Module):
    ...
    def __init__(self, in_chn=3, num_pyramids=5,num_blocks=5, num_feature=32,relu_slope=0.2):
        ...
        self.fup0 = freup_Cornerdinterpolation(3)
        ...
        self.fup1 = freup_Cornerdinterpolation(3)
        ...
        self.fup2 = freup_Cornerdinterpolation(3)
        ...
        self.fup3= freup_Cornerdinterpolation(3)
