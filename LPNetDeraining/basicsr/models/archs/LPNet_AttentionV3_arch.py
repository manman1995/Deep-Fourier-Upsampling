...
class freup_pad_simple_attention(nn.Module):
    def __init__(self, channels, dropout=0.1, use_attention=False):
        super(freup_pad_simple_attention, self).__init__()
...
class LPNet_simple_attention(nn.Module):
    ...
    def __init__(self, in_chn=3, num_pyramids=5, num_blocks=5, num_feature=32, relu_slope=0.2):
        ...
        self.fup0 = freup_pad_simple_attention(3, dropout=0.3, use_attention=True)
        ...
        self.fup1 = freup_pad_simple_attention(3, dropout=0.3, use_attention=True)
        ...
        self.fup2 = freup_pad_simple_attention(3, dropout=0.3, use_attention=True)
        ...
        self.fup3 = freup_pad_simple_attention(3, dropout=0.3, use_attention=True)
