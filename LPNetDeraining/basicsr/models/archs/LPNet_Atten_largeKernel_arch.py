...
class LPNet_Atten_largeKernel(nn.Module):
    ...
    def __init__(self, in_chn=3, num_pyramids=5,num_blocks=5, num_feature=32,relu_slope=0.2):
        ...
        self.fuse_0 = nn.Conv2d(6, 3, kernel_size=3, stride=1, padding=1)
        ...
        self.fuse_1 = nn.Conv2d(6, 3, kernel_size=3, stride=1, padding=1)
        ...
        self.fuse_2 = nn.Conv2d(6, 3, kernel_size=3, stride=1, padding=1)
        ...
        self.fuse_3 = nn.Conv2d(6, 3, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, images):
        ...
        out_3_t = out_3_t + self.fup3(out_3)
