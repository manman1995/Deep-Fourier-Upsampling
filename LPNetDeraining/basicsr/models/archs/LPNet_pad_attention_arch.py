...
class FrequencyAttention(nn.Module):
    def __init__(self, channels, num_heads=2, dim_head=8, dropout=0.0):
...
class freup_pad_attention(nn.Module):
    def __init__(self, channels, num_heads=2, dim_head=8, dropout=0.0, use_attention=True):
...
class LPNet_pad_attention(nn.Module):
    ...
    def forward(self, images):
        ...
        out_3_t = out_3_t + self.fup3(out_3) # i think this is not necessary
