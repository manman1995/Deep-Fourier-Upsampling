...
class PRENetModel(BaseModel):
    """Base Deblur model for single image deblur."""

    def __init__(self, opt):
        super(PRENetModel, self).__init__(opt)
    ...
    def optimize_parameters(self, current_iter):
        ...
        l_ssim_loss = self.ssim_loss(preds[-1], self.gt)

        loss_dict['l_ssim_loss'] = l_ssim_loss
        l_total =l_ssim_loss
