...
def create_lmdb_for_rain13k():
    folder_path = '/research/datasets/RAIN_SYN/RAIN13K/train/rainy_image'
    lmdb_path = '/research/datasets/RAIN_SYN/RAIN13K/train/rainy_image.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/research/datasets/RAIN_SYN/RAIN13K/train/ground_truth'
    lmdb_path = '/research/datasets/RAIN_SYN/RAIN13K/train/ground_truth.lmdb'
